...
namespace glm
{
    ...
    /// Low single-precision floating-point aabb 2d
    ///
    typedef taabb<f32, lowp, tvec2> lowp_f32aabb2;

    /// Low single-precision floating-point aabb 3d
    ///
    typedef taabb<f32, lowp, tvec3> lowp_f32aabb3;

    /// Low double-precision floating-point aabb 2d
    ///
    typedef taabb<f64, lowp, tvec2> lowp_f64aabb2;

    /// Low double-precision floating-point aabb 3d
    ///
    typedef taabb<f64, lowp, tvec3> lowp_f64aabb3;

    /// Medium single-precision floating-point aabb 2d
    ///
    typedef taabb<f32, mediump, tvec2> mediump_f32aabb2;

    /// Medium single-precision floating-point aabb 3d
    ///
    typedef taabb<f32, mediump, tvec3> mediump_f32aabb3;

    /// Medium double-precision floating-point aabb 2d
    ///
    typedef taabb<f64, mediump, tvec2> mediump_f64aabb2;

    /// Medium double-precision floating-point aabb 3d
    ///
    typedef taabb<f64, mediump, tvec3> mediump_f64aabb3;

    /// High single-precision floating-point aabb 2d
    ///
    typedef taabb<f32, highp, tvec2> highp_f32aabb2;

    /// High single-precision floating-point aabb 3d
    ///
    typedef taabb<f32, highp, tvec3> highp_f32aabb3;

    /// High double-precision floating-point aabb 2d
    ///
    typedef taabb<f64, highp, tvec2> highp_f64aabb2;

    /// High double-precision floating-point aabb 3d
    ///
    typedef taabb<f64, highp, tvec3> highp_f64aabb3;

    //////////////////////////////////////////////
    // capsule

    /// Low single-precision floating-point capsule
    ///
    typedef tcapsule<f32, lowp> lowp_f32capsule;

    /// Low double-precision floating-point capsule
    ///
    typedef tcapsule<f64, lowp> lowp_f64capsule;

    /// Medium single-precision floating-point capsule
    ///
    typedef tcapsule<f32, mediump> mediump_f32capsule;

    /// Medium double-precision floating-point capsule
    ///
    typedef tcapsule<f64, mediump> mediump_f64capsule;

    /// High single-precision floating-point capsule
    ///
    typedef tcapsule<f32, highp> highp_f32capsule;

    /// High double-precision floating-point capsule
    ///
    typedef tcapsule<f64, highp> highp_f64capsule;
    ...
    typedef highp_f32aabb2          highp_faabb2;
    typedef highp_f32aabb3          highp_faabb3;
    typedef highp_faabb2            faabb2;
    typedef highp_faabb3            faabb3;

    /// capsule
    /// 

    typedef highp_f32capsule        highp_fcapsule;
    typedef highp_fcapsule          fcapsule;
    ...
    /// Default single-precision floating-point aabb 2d.
    /// @see gtc_type_precision
    typedef highp_f32aabb2           f32aabb2;

    /// Default single-precision floating-point aabb 3d.
    /// @see gtc_type_precision
    typedef highp_f32aabb3           f32aabb3;
    ...
    /// Default single-precision floating-point aabb 2d.
    /// @see gtc_type_precision
    typedef highp_f32capsule           f32capsule;
